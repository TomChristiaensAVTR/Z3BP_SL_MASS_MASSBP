*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMASS_V_PARALLEL
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMASS_V_PARALLEL    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMASS_V_PARALLEL'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMASS_V_PARALLEL_EXTRACT
TOTAL = ZMASS_V_PARALLEL_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMASS_V_PARALLEL'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMASS_V_PARALLEL-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMASS_V_PARALLEL_EXTRACT
TOTAL = ZMASS_V_PARALLEL_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMASS_V_PARALLEL-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMASS_V_PARALLEL'
...
TOTAL = ZMASS_V_PARALLEL_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMASS_V_PARALLEL-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMASS_V_PARALLEL-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMASS_V_PARALLEL'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMASS_V_PARALLEL-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMASS_V_PARALLEL_EXTRACT
TOTAL = ZMASS_V_PARALLEL_TOTAL
